...
Motor.prototype.forever = function (speed, opts) {
  ...
  writeAndCache('stop_command', braking).bind(this)
  writeAndCache('command', 'run-forever').bind(this)
}
...
Motor.prototype.degrees = function (degrees, opts) {
  ...
  writeAndCache('position_sp', degrees.toString()).bind(this)
  writeAndCache('speed_sp', speed.toString()).bind(this)
  writeAndCache('stop_command', braking).bind(this)
...
Motor.prototype.timed = function (time, opts) {
  ...
  writeAndCache('time_sp', time.toString()).bind(this)
  writeAndCache('speed_sp', speed.toString()).bind(this)
  writeAndCache('stop_command', braking).bind(this)
...
Motor.prototype.runToAbsPos = function (position, opts) {
  ...
  writeAndCache('speed_sp', speed.toString()).bind(this)
  writeAndCache('position_sp', position.toString()).bind(this)
  writeAndCache('stop_command', braking).bind(this)
...
function writeAndCache (command, value) {
  if (moveCache.get(command) === value) return
